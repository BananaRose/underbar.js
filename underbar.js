(function() {
  ...
  // unique([1,2,3,4,5], isEven)
  // unique([1,2,3,4,5], true, isEven)
  ...
  // Takes an array of objects and returns an
  // array of the values of
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      return result[parameter] = result[parameter] || func.apply(this, arguments);
    };
  };
  ...
  _.shuffle = function(array) {
    var coppy = array.slice();
    for (var i = 0; i < coppy.length; i++) {
      var randomIndex = Math.floor(Math.random() * (i + 1));
      var randomItem = coppy[randomIndex];
      coppy[randomIndex] = coppy[i];
      coppy[i] = randomItem;
    }
    return coppy;
  };
